  ...
  const contactMethods: ContactMethod[] = [
    {
      ...
      title: 'EMAIL',
      value: 'nhlakanipho.dev@gmail.com',
      href: 'mailto:nhlakanipho.dev@gmail.com'
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="relative bg-gradient-to-br from-[#15142b]/80 via-[#191F3A]/90 to-[#15142b]/80 backdrop-blur-sm border border-kaiju-green/20 rounded-lg p-6 text-center">
                  ...
                  <div className="flex flex-wrap gap-4 justify-center">
                    {[
                      {
                        name: 'GitHub',
                        href: 'https://github.com/nhlakanipho',
                        icon: (
                      ...
                      {
                        name: 'LinkedIn',
                        href: 'https://linkedin.com/in/nhlakanipho',
                        icon: (
                          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      {
                        name: 'Instagram',
                        href: 'https://instagram.com/nhlakanipho',
                        icon: (
                          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
